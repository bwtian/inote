...
|---------------+-----------------+-------------+-------------------------------+------------------------------------+-------------------|
| Options       | cite            | citep       | cite                          | \citeX{jon90}                      |                   |
| to natbib     | \let\cite\citep | -           | natbib=true                   |                                    |                   |
| to biblatex   |                 |             | -                             |                                    |                   |
|---------------+-----------------+-------------+-------------------------------+------------------------------------+-------------------|
...
| bibentry      |                 |             |                               |                                    |                   |
|---------------+-----------------+-------------+-------------------------------+------------------------------------+-------------------|
|               | plain           | plainat     | style=numeric                 |                                    |                   |
|               | abbrv           | abbrvnat    | style=numeric,firstinits=true |                                    |                   |
|               | unsrt           |             | style=numeric,sorting=none    |                                    |                   |
|               | alpha           |             | style=alphabetic              |                                    |                   |
|---------------+-----------------+-------------+-------------------------------+------------------------------------+-------------------|
